...
{
	if (rt_kernel_space.start == RT_NULL || rt_kernel_space.size == 0)
    {
        rt_kprintf("Kernel memory space not initialized.\n");
        rt_kprintf("MMU functionality may not be enabled in this configuration.\n");
        return;
    }
