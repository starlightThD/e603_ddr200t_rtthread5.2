...
synth_design -include_dirs $env(INSTALL_RTL)/subsys/  -include_dirs $env(INSTALL_RTL)/core/ -top $top -flatten_hierarchy rebuilt
...
write_bitstream -force [file join $wrkdir "$env(BITFILE_NAME)"]
